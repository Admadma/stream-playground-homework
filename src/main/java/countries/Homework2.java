...
public class Homework2 {
    ...
    public void streamPipeline4() {
        countries.stream().filter(x -> !x.getName().contains(" ")).map(Country::getName).forEach(System.out::println);
    }
    ...
    public boolean streamPipeline6() {
        // TODO
        // countries.stream().filter(x -> new StringBuilder(x.getCapital()).reverse() == new StringBuilder(x.getCapital())
        return false;
    }
